...
// build dev task
gulp.task('buildDev', ['html', 'css', 'images', 'js', 'libs', 'htaccess', 'dev']);

// build prod task
gulp.task('buildProd', ['html', 'css', 'images', 'js', 'libs', 'htaccess', 'prod']);

// dev task
gulp.task('dev', function () {
    gulp.src('./config.json')
    .pipe(ngConfig('theSetApp.config', {
        environment: 'dev'
    }))
...
gulp.task('htaccess', function() {
    return gulp.src(source+'/**/.htaccess', {base: source}).pipe(gulp.dest(dest));
});
...
gulp.task('watch', function() {
    ...
    gulp.watch(source+'/**/.htaccess', ['htaccess', reload]);
