						...
						<!-- Content -->
							<div class="wrapper">
								<div class="inner">
									...
									?>
									<p style="height:130px"><a href="viewalbum.php?album_id=<?php echo $albumsrow["album_id"]; ?>"><img src="images/albums/<?php echo $albumsrow["album_id"]; ?>.jpg" border=0 style="float:left;height:100px;width:100px;padding:5px;"></a><b><?php echo($albumsrow["source_name"]); ?>'s</b> Pick: <b><a href="viewalbum.php?album_id=<?php echo $albumsrow["album_id"]; ?>"><?php echo($albumsrow["album_name"]); ?></a></b> by <b><a href="viewartist.php?artist_id=<?php echo $albumsrow["album_id"]; ?>"><?php echo($albumsrow["artist_name"]); ?></a></b><br>
