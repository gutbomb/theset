...
<h2 class="major">Last week's assignment: <?php echo($previousyear); ?></h2>
										...
										?>
										<h3><?php echo $prevalbumsrow["source_name"]; ?>'s Pick: <a href="viewalbum.php?album_id=<?php echo $prevalbumsrow["album_id"]; ?>"><?php echo $prevalbumsrow["album_name"]; ?></a> by <a href="viewartist.php?artist_id=<?php echo $prevalbumsrow["artist_id"]; ?>"><?php echo $prevalbumsrow["artist_name"]; ?></a></h3>
							...
							<section id="three" class="wrapper spotlight style3">
								<div class="inner">
									...
									<div class="content">
										...
										?>
										<h3><?php echo $activealbumsrow["source_name"]; ?>'s Pick: <a href="submitratings.php?album_id=<?php echo $activealbumsrow["album_id"]; ?>"><?php echo $activealbumsrow["album_name"]; ?></a> by <a href="viewartist.php?artist_id=<?php echo $activealbumsrow["artist_id"]; ?>"><?php echo $activealbumsrow["artist_name"]; ?></a></h3>
